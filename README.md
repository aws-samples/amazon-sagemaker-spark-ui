...
* This solution use an updated version of the file org/apache/spark/ui/static/utils.js, for solving a known bug on the Spark implementation related to the proxy
